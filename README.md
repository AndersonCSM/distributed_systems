# Distributed Systems - Course Projects Repository
...
│   ├── projeto_01/                  # AWS EC2 Web Server
│   ├── projeto_02/                  # React/Vite Deployment
│   ├── projeto_03/                  # WordPress + RDS Distributed Architecture
│   ├── projeto_04/                  # AI-Powered Game (React + TypeScript)
│   ├── projeto_05/                  # Docker/ECR/ECS Pipeline
│   ├── projeto_06/                  # Project Template
...
2. Select any project and review its dedicated README for:
...
|---|---------|------|------------------|
| 01 | [EC2 Web Server](course/projeto_01/README.md) | Infrastructure | AWS, Apache, SSH |
| 02 | [React Deploy](course/projeto_02/README.md) | Frontend | React, Vite, Apache |
| 03 | [WordPress + RDS](course/projeto_03/README.md) | Full-stack | WordPress, MySQL, RDS |
| 04 | [AI Game](course/projeto_04/README.md) | Frontend | React, TypeScript, Tailwind |
| 05 | [Docker/ECS](course/projeto_05/README.md) | DevOps | Docker, ECR, ECS, ALB |
| 06 | [Template](course/projeto_06/README.md) | Template | Project template |
...
- **AWS Academy:** Learner Lab environment for practical learning
...
### Project 02: Frontend Deployment
- Build optimization with Vite
- Single Page Application (SPA) routing
- Secure file transfer (SCP)
- Apache VirtualHost configuration

### Project 03: Distributed Architecture
- Multi-tier architecture design patterns
- Database separation with RDS
- Service-oriented architecture
- WordPress + WooCommerce e-commerce integration

### Project 04: Interactive Development
- React component-based architecture
- TypeScript for type safety
- Game logic and AI implementation
- Algorithm design (Minimax, Greedy strategies)

### Project 05: Containerization & Orchestration
- Docker multi-stage build optimization
- Container registry (Amazon ECR)
- ECS Fargate serverless orchestration
- Auto-scaling and Application Load Balancing

### Project 07: Full-Stack Development
- Monorepo architecture for scalable projects
...
1. Read this file (repository overview)
   ↓
2. Visit course/README.md (projects summary)
   ↓
3. Select project of interest
   ↓
...
**Repository Version:** 1.0 - Standardized Documentation  
**Language:** English (Português available in individual project files)
