...
```bash
npm install
npm run dev  # Inicia server + client
```
📖 Detalhes: Ver [SETUP.md](docs/SETUP.md)
...
```
📖 Guia Completo: Ver [EC2-DEPLOYMENT.md](docs/EC2-DEPLOYMENT.md)

### Documentação Importante
- 🏗️ [ARCHITECTURE.md](docs/ARCHITECTURE.md) - Arquitetura do projeto
- 📡 [API.md](docs/API.md) - Endpoints e tipos
- 🔧 [SETUP.md](docs/SETUP.md) - Setup local e EC2
- ☁️ [EC2-DEPLOYMENT.md](docs/EC2-DEPLOYMENT.md) - Deploy em produção
- ✅ [IMPLEMENTATION-STATUS.md](docs/IMPLEMENTATION-STATUS.md) - Status das fases
...
### **Fase 2: Lógica do Jogo Core** ✅ (Completo)
- ✅ GameService: lógica de movimentos e validação
- ✅ Inicialização de jogo (embaralhar peças, distribuir)
- ✅ Validação de movimentos (peça válida, mão válida)
- ✅ Sistema de turnos (próximo jogador, ordem horária)
- ✅ Verificação de vitória (hand, trancado, carroça)
- ✅ Sistema de pontuação completo
- ✅ Compra de peças (draw) até ter jogada válida
- ✅ Flip automático de peças

### **Fase 3: Gerenciamento de Salas** ✅ (Completo)
...
- ✅ Status de sala e jogador
- ✅ Código aleatório de sala
- ✅ Integração com GameService

### **Fase 4: Backend - Socket.IO Handlers** ✅ (100% Completo)
- ✅ Handler: `create_room` - Criar sala
- ✅ Handler: `join_room` - Entrar na sala
- ✅ Handler: `leave_room` - Sair da sala
- ✅ Handler: `list_rooms` - Listar salas
- ✅ Handler: `get_room_info` - Info da sala
- ✅ Handler: `player_ready` - Marcar como pronto
- ✅ Handler: `start_game` - Iniciar jogo
- ✅ Handler: `play_move` - Executar movimento
- ✅ Handler: `pass_turn` - Passar turno
- ✅ Handler: `draw_piece` - Comprar peça
- ✅ Handler: `sync_game_state` - Sincronizar estado (reconexão)
